...
// color, emission and type (diffuse, specular, refractive)
...
class Plane : public Obj {  //plane object
	public:
	Vec n;
	double d;
...
class Sphere : public Obj {   //Sphere object
	public:
	Vec c;
	double r;
...
//	add(new Sphere(0.45,Vec(0.8,-2.05,-3.7)),Vec(10,10,1),0,3); // Right sphere
	...
	params["spp"] = 15.0; // samples per pixel
